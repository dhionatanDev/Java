...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println("Informe o dia da Locação: domingo = 1, Segunda = 2, terça = 3, quarta = 4, quinta = 5"
					+ "sexta = 6, sabado = 7");
			dia = lerTeclado.nextInt();
			if (dia >= 1 && dia <= 7) {
				do {
					System.out.println("Informe o tipo de fita: N = Normal, L = Lançamento");
